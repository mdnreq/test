...
export const CAMPAIGN_SERVICE_CATALOG: CampaignServiceDefinition[] = [
  ...
  // CRITICAL GAP SERVICES - REVENUE DRIVERS (Consolidated - Single Version per Service)
  { id: "73", name: "Paid Media Management", description: "Premium paid media across all platforms: TikTok, LinkedIn, YouTube, Google, Meta with advanced AI-powered optimization", category: "Digital Marketing", price_monthly: 4995, price_display: "$4,995/month + ad spend", tier: ["top-tier"], bestFor: ["Top-Tier Mayor", "Top-Tier Councillor"], features: ["All platform ads (Meta, Google, TikTok, LinkedIn, YouTube)", "AI budget allocation", "Real-time bidding optimization", "A/B testing automation", "Daily performance reports", "Conversion tracking"], popular: true },
  
  { id: "74", name: "Voter Data Enrichment", description: "Premium voter data with behavioral segmentation, predictive scoring, and microsegmentation", category: "Analytics", price_monthly: 1295, price_display: "$1,295/month", tier: ["top-tier", "lean"], bestFor: ["All Tiers"], features: ["Complete voter universe (1M+ records)", "Behavioral segmentation", "Predictive persuasion scoring", "Issue-based microsegmentation", "Donor propensity modeling", "Real-time data feeds"], popular: true },
  
  { id: "75", name: "Phone Banking System", description: "Advanced phone banking with AI transcription, sentiment analysis, and optimization", category: "Field Operations", price_monthly: 1595, price_display: "$1,595/month", tier: ["top-tier", "lean"], bestFor: ["All Tiers"], features: ["Unlimited concurrent callers", "AI call transcription", "Sentiment analysis", "Auto dialing", "Live call coaching", "Performance leaderboards", "Predictive dialing"], popular: true },
  
  { id: "76", name: "Debate Prep & Media Training", description: "Premium executive coaching with video analysis, opposition briefings, and crisis scenarios", category: "Content Creation", price_monthly: 3495, price_display: "$3,495/session", tier: ["top-tier"], bestFor: ["Top-Tier Mayor", "Top-Tier Councillor"], features: ["Multiple debate simulations", "Video analysis & playback", "Opposition research briefing", "Crisis scenario training", "Media interview coaching", "Post-debate analysis"], popular: true },
  
  { id: "77", name: "Campaign Video Production", description: "Premium video production with 4K delivery, drone footage, animation, and broadcast quality", category: "Content Creation", price_monthly: 4495, price_display: "$4,495/month", tier: ["top-tier"], bestFor: ["Top-Tier Mayor", "Top-Tier Councillor"], features: ["Unlimited video production", "4K broadcast quality", "Drone footage", "3D animation", "Motion graphics", "Color grading", "Sound design", "Weekly delivery"], popular: true },
  
  { id: "78", name: "Campaign Branding Pro", description: "Premium branding with custom typography, brand voice development, and comprehensive guidelines", category: "Design", price_monthly: 2495, price_display: "$2,495 one-time", tier: ["top-tier", "lean"], bestFor: ["All Tiers"], features: ["Logo design (10 concepts, unlimited revisions)", "300-page brand guidelines", "Custom typography", "Brand voice & messaging guidelines", "All digital & print templates", "Style guide animations", "Brand evolution planning"], popular: true },
  
  { id: "79", name: "Campaign Website Elite", description: "Premium website with mobile app companion, AI chatbot, and enterprise features", category: "Web Development", price_monthly: 4995, price_display: "$4,995 one-time", tier: ["top-tier"], bestFor: ["Top-Tier Mayor", "Top-Tier Councillor"], features: ["Mobile app (iOS/Android)", "AI voter chatbot", "Multi-currency support", "API integrations", "White-label ready", "1-year hosting/support", "Advanced CRM integration", "Donation recurring billing"], popular: false },
