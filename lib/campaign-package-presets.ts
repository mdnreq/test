...
export const CAMPAIGN_PACKAGE_PRESETS: CampaignPackagePreset[] = [
  ...
  },
  {
    ...
    cycleMonths: 5,
    mustHaveMonthlyRetainers: ["2", "17", "22", "23", "73", "74", "75", "77", "78"],
    ...
    recommendedAddOns: ["26", "61", "14", "76", "79", "80"],
  ...
  },
  {
    ...
    description: "A competitive ward package with field discipline, digital persuasion, volunteer throughput, and analytics built in.",
