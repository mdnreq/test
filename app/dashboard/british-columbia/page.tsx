...
export default function BritishColumbiaDashboard() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-5xl font-black tracking-tight mb-2">BRITISH COLUMBIA</h1>
          <p className="text-xl text-muted-foreground">Municipal democracy across BC - October 15, 2026 election</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-amber-600/10 to-orange-600/10 border border-amber-600/20 rounded-xl p-6 mb-8">
          <p className="text-sm leading-relaxed">
            We acknowledge that British Columbia municipalities are situated on the traditional and unceded territories
            of many Indigenous Nations, including the Coast Salish, Interior Salish, Haida, Nisga'a, Tlingit, Tsimshian,
            and many others who have stewarded these lands since time immemorial.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-card border rounded-xl p-6">
            ...
            <div className="text-3xl font-black mb-1 text-red-500">-5.6%</div>
          ...
          <div className="bg-card border rounded-xl p-6">
            ...
            <div className="text-3xl font-black mb-1">34.2%</div>
        ...
        {/* ... Rest of dashboard with Youth Concentration, Habit Formation, GOTV Funnel, and Municipality Table ... */}

        {/* Municipalities Table */}
        <div className="bg-card border rounded-xl overflow-hidden">
          <div className="border-b p-6">
            <h2 className="text-2xl font-bold">BC MUNICIPALITIES</h2>
          </div>
